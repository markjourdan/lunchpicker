...
using LunchPicker.Web.Models.Account;
...
namespace LunchPicker.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.ReturnUrl = returnUrl;
            return PartialView("Partial/ExternalLoginsList", OAuthWebSecurity.RegisteredClientData);
        }
        ...
        public ActionResult RemoveExternalLogins()
        {
            ...
            return PartialView("Partial/RemoveExternalLogins", externalLogins);
        }
